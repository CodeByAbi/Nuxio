...
| Regression Testing | Suite E2E dijalankan wajib di CI sebelum merge ke `develop` dan sebelum deploy ke `production` | Mencegah fitur yang sudah bekerja (khususnya jalur finansial kritis) rusak akibat perubahan tidak terkait — regresi pada aplikasi finansial berarti hilangnya kepercayaan user, bukan sekadar bug kosmetik. |
