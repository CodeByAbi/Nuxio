...
5. Tidak ada dependensi sirkular antar modul (dijaga oleh aturan _owned data_: modul hanya boleh menulis data yang ia miliki).
...
- **Calendar** adalah _projection_ murni: hanya membaca, tidak memiliki data sendiri.
- **AI Copilot** adalah _consumer_ murni: membaca agregat dari seluruh domain service, tidak pernah menulis.
- **Notification** hanya _menunggu_ trigger dari Budget, Forecast, dan Recurring — tidak pernah menjadi dependency bagi modul lain.
